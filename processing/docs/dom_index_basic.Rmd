...
At the Table \@ref(tab:fit) git measures of all calculated models are showed. In general, all models shows good fit measures, being CFI > 0.99.
...
At the Table \@ref(tab:w2) estimates of the crosslagged regressions are showed for the constrained models. It is observed that a deviation of one point above the average level of trust in trade unions predicts a negative deviation of 0.029 in SDO during the next measurement, controlling for deviations from the expected score in SDO.
