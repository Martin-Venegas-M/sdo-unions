...
b1 <- '
    ...
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + CONF_INDEX2 + IDEOL2 + EDUC2 + g*edad1 + x*sexo1  
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + CONF_INDEX3 + IDEOL3 + EDUC3 + g*edad1 + x*sexo1 
    CS2 ~ CS1
    CS3 ~ CS2
    CS4 ~ CS3
    CONF_INDEX4 ~ CONF_INDEX3
...
b2 <- '
    ...
    DOM_INDEX3 ~ a*DOM_INDEX2 + b*CS2 + c*CONF_INDEX2 + d*IDEOL2 + f*EDUC2 + g*edad1 + x*sexo1
    DOM_INDEX4 ~ a*DOM_INDEX3 + b*CS3 + c*CONF_INDEX3 + d*IDEOL3 + f*EDUC3 + g*edad1 + x*sexo1
    CS2 ~ i*CS1
    CS3 ~ i*CS2
    CS4 ~ i*CS3
    CONF_INDEX4 ~ o*CONF_INDEX3
...
c1 <- '
    ...
    CS3 ~ DOM_INDEX2 + CS2 + CONF_INDEX2 + IDEOL2 + EDUC2 + n*edad1 + z*sexo1
    CS4 ~ DOM_INDEX3 + CS3 + CONF_INDEX3 + IDEOL3 + EDUC3 + n*edad1 + z*sexo1
    CONF_INDEX4 ~ CONF_INDEX3
    CONF_INDEX3 ~ CONF_INDEX2
    CONF_INDEX2 ~ CONF_INDEX1
    IDEOL4 ~ IDEOL3
...
c2 <- '
    ...
    CS3 ~ h*DOM_INDEX2 + i*CS2 + j*CONF_INDEX2 + k*IDEOL2 + m*EDUC2 + n*edad1 + z*sexo1
    CS4 ~ h*DOM_INDEX3 + i*CS3 + j*CONF_INDEX3 + k*IDEOL3 + m*EDUC3 + n*edad1 + z*sexo1
    CONF_INDEX4 ~ o*CONF_INDEX3
    CONF_INDEX3 ~ o*CONF_INDEX2
    CONF_INDEX2 ~ o*CONF_INDEX1
    IDEOL4 ~ p*IDEOL3
