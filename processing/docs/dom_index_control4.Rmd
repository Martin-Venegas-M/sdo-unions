...
title: |
  ...
  RI-CLPM Control Model 4 (Education): SDO & Trust in Trade Unions
...
bwcomp <- ' 
    ...
    RI_z =~ 1*educ1 + 1*educ2 + 1*educ3 + 1*educ4
...
b1 <- '
    ...
    DOM_INDEX3 ~ DOM_INDEX2
    DOM_INDEX4 ~ DOM_INDEX3 
    CS2 ~ DOM_INDEX1 + CS1 + EDUC1 
    CS3 ~ DOM_INDEX2 + CS2 + EDUC1 
    CS4 ~ DOM_INDEX3 + CS3 + EDUC1 
    EDUC4 ~ EDUC3
    EDUC3 ~ EDUC2
    EDUC2 ~ EDUC1
'
...
b2 <- '
    ...
    DOM_INDEX3 ~ a*DOM_INDEX2
    DOM_INDEX4 ~ a*DOM_INDEX3 
    CS2 ~ c*DOM_INDEX1 + d*CS1 + f*EDUC1 
    CS3 ~ c*DOM_INDEX2 + d*CS2 + f*EDUC2 
    CS4 ~ c*DOM_INDEX3 + d*CS3 + f*EDUC3 
    EDUC4 ~ g*EDUC3
    EDUC3 ~ g*EDUC2
    EDUC2 ~ g*EDUC1
'
...
### Backward: free
c1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + EDUC1                   
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + EDUC2 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + EDUC3 
    CS2 ~ CS1 
    CS3 ~ CS2
    CS4 ~ CS3
    EDUC4 ~ EDUC3
...
c2 <- '
    DOM_INDEX2 ~ a*DOM_INDEX1 + b*CS1 + e*EDUC1                   
    DOM_INDEX3 ~ a*DOM_INDEX2 + b*CS2 + e*EDUC2 
    DOM_INDEX4 ~ a*DOM_INDEX3 + b*CS3 + e*EDUC3 
    CS2 ~ d*CS1 
    CS3 ~ d*CS2
    CS4 ~ d*CS3
    EDUC4 ~ g*EDUC3
...
d1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + EDUC1                  
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + EDUC1 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + EDUC1 
    CS2 ~ DOM_INDEX1 + CS1 + EDUC1 
    CS3 ~ DOM_INDEX2 + CS2 + EDUC1 
    CS4 ~ DOM_INDEX3 + CS3 + EDUC1 
    EDUC4 ~ EDUC3
