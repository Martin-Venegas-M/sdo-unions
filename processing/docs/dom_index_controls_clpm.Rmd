...
kable(param_b1[op=="~" & rhs %in% param_b1$rhs[c(33:71)] & lhs %in% param_b1$lhs[c(33:71)] , !"label"],
      digits = 3,
...
kable(param_b2[op=="~" & rhs %in% param_b2$rhs[c(33:71)] & lhs %in% param_b2$lhs[c(33:71)] , !"label"],
      digits = 3,
...
kable(param_d1[op=="~" & rhs %in% param_d1$rhs[c(33:80)] & lhs %in% param_d1$lhs[c(33:80)] , !"label"],
      digits = 3,
      caption = "D1 model interpretations of within components") %>% 
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T) %>% 
   row_spec(c(2, 25, 33, 41), bold = T, color = "white", background = "#E37383") %>% 
  row_spec(c(10, 18), bold = T, color = "white", background = "#9CE599") # Añadir destacado
```
...
kable(param_d2[op=="~" & rhs %in% param_d2$rhs[c(33:80)] & lhs %in% param_d2$lhs[c(33:80)] , !"label"],
      digits = 3,
