...
title: |
  ...
  RI-CLPM Basic Controls: SDO & Trust in Trade Unions
...
elsoc <- readRDS("../../input/data/proc/elsoc_dep.RDS")
```
...
kable(param_d1_regs,
  ...
  row_spec(which(param_d1_regs$pvalue < 0.05), bold = T, color = "white", background = "#9CE599") # Añadir destacado
```
...
kable(param_d2_regs,
  ...
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T) %>% 
  row_spec(which(param_d2_regs$pvalue < 0.05), bold = T, color = "white", background = "#9CE599")
```
