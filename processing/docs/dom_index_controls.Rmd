...
kable(param_d1[op=="~" & rhs %in% param_d1$rhs[c(57:80)] & lhs %in% param_d1$lhs[c(57:80)] , !"label"],
      digits = 3,
...
kable(param_d2[op=="~" & rhs %in% param_d2$rhs[c(57:80)] & lhs %in% param_d2$lhs[c(57:80)] , !"label"],
      digits = 3,
