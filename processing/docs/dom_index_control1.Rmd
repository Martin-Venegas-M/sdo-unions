...
title: |
  ...
  RI-CLPM Control Model 1 (Trust in Institutions): SDO & Trust in Trade Unions
...
a2 <- '
    ...
    CS3 ~ d*CS2
    CS4 ~ d*CS3
    CONF_INDEX4 ~ g*CONF_INDEX3
    CONF_INDEX3 ~ g*CONF_INDEX2
    CONF_INDEX2 ~ g*CONF_INDEX1
'
...
b1 <- '
    ...
    DOM_INDEX3 ~ DOM_INDEX2
    DOM_INDEX4 ~ DOM_INDEX3 
    CS2 ~ DOM_INDEX1 + CS1 + CONF_INDEX1 
    CS3 ~ DOM_INDEX2 + CS2 + CONF_INDEX1 
    CS4 ~ DOM_INDEX3 + CS3 + CONF_INDEX1 
    CONF_INDEX4 ~ CONF_INDEX3
    CONF_INDEX3 ~ CONF_INDEX2
    CONF_INDEX2 ~ CONF_INDEX1
'
...
b2 <- '
    ...
    DOM_INDEX3 ~ a*DOM_INDEX2
    DOM_INDEX4 ~ a*DOM_INDEX3 
    CS2 ~ c*DOM_INDEX1 + d*CS1 + f*CONF_INDEX1 
    CS3 ~ c*DOM_INDEX2 + d*CS2 + f*CONF_INDEX2 
    CS4 ~ c*DOM_INDEX3 + d*CS3 + f*CONF_INDEX3 
    CONF_INDEX4 ~ g*CONF_INDEX3
    CONF_INDEX3 ~ g*CONF_INDEX2
    CONF_INDEX2 ~ g*CONF_INDEX1
'
...
### Backward: free
c1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + CONF_INDEX1                   
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + CONF_INDEX2 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + CONF_INDEX3 
    CS2 ~ CS1 
    CS3 ~ CS2
    CS4 ~ CS3
    CONF_INDEX4 ~ CONF_INDEX3
...
c2 <- '
    DOM_INDEX2 ~ a*DOM_INDEX1 + b*CS1 + e*CONF_INDEX1                   
    DOM_INDEX3 ~ a*DOM_INDEX2 + b*CS2 + e*CONF_INDEX2 
    DOM_INDEX4 ~ a*DOM_INDEX3 + b*CS3 + e*CONF_INDEX3 
    CS2 ~ d*CS1 
    CS3 ~ d*CS2
    CS4 ~ d*CS3
    CONF_INDEX4 ~ g*CONF_INDEX3
...
d1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + CONF_INDEX1                  
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + CONF_INDEX1 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + CONF_INDEX1 
    CS2 ~ DOM_INDEX1 + CS1 + CONF_INDEX1 
    CS3 ~ DOM_INDEX2 + CS2 + CONF_INDEX1 
    CS4 ~ DOM_INDEX3 + CS3 + CONF_INDEX1 
    CONF_INDEX4 ~ CONF_INDEX3
