...
title: |
  ...
  RI-CLPM Control Model 3 (Income Deciles): SDO & Trust in Trade Unions
...
bwcomp <- ' 
    ...
    RI_z =~ 1*decile1 + 1*decile2 + 1*decile3 + 1*decile4
...
b1 <- '
    ...
    DOM_INDEX3 ~ DOM_INDEX2
    DOM_INDEX4 ~ DOM_INDEX3 
    CS2 ~ DOM_INDEX1 + CS1 + DECILE1 
    CS3 ~ DOM_INDEX2 + CS2 + DECILE1 
    CS4 ~ DOM_INDEX3 + CS3 + DECILE1 
    DECILE4 ~ DECILE3
    DECILE3 ~ DECILE2
    DECILE2 ~ DECILE1
'
...
b2 <- '
    ...
    DOM_INDEX3 ~ a*DOM_INDEX2
    DOM_INDEX4 ~ a*DOM_INDEX3 
    CS2 ~ c*DOM_INDEX1 + d*CS1 + f*DECILE1 
    CS3 ~ c*DOM_INDEX2 + d*CS2 + f*DECILE2 
    CS4 ~ c*DOM_INDEX3 + d*CS3 + f*DECILE3 
    DECILE4 ~ g*DECILE3
    DECILE3 ~ g*DECILE2
    DECILE2 ~ g*DECILE1
'
...
### Backward: free
c1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + DECILE1                   
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + DECILE2 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + DECILE3 
    CS2 ~ CS1 
    CS3 ~ CS2
    CS4 ~ CS3
    DECILE4 ~ DECILE3
...
c2 <- '
    DOM_INDEX2 ~ a*DOM_INDEX1 + b*CS1 + e*DECILE1                   
    DOM_INDEX3 ~ a*DOM_INDEX2 + b*CS2 + e*DECILE2 
    DOM_INDEX4 ~ a*DOM_INDEX3 + b*CS3 + e*DECILE3 
    CS2 ~ d*CS1 
    CS3 ~ d*CS2
    CS4 ~ d*CS3
    DECILE4 ~ g*DECILE3
...
d1 <- '
    DOM_INDEX2 ~ DOM_INDEX1 + CS1 + DECILE1                  
    DOM_INDEX3 ~ DOM_INDEX2 + CS2 + DECILE1 
    DOM_INDEX4 ~ DOM_INDEX3 + CS3 + DECILE1 
    CS2 ~ DOM_INDEX1 + CS1 + DECILE1 
    CS3 ~ DOM_INDEX2 + CS2 + DECILE1 
    CS4 ~ DOM_INDEX3 + CS3 + DECILE1 
    DECILE4 ~ DECILE3
